...
function initGrid() {
    ...
    $("#grid").jqGrid({
        url: "../basedata/basedata.aspx?action=get&type=unit&isDelete=2",
        datatype: "json",
...
var handle = {
    ...
    del: function (t) {
        $.dialog.confirm("删除的单位将不能恢复，请确认是否删除？",
        function () {
