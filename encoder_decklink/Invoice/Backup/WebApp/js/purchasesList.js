...
THISPAGE = {
    ...
    loadGrid: function () {
        ...
        $("#grid").jqGrid({
            url: "../scm/invPurList.aspx?action=list",
    ...
    addEvent: function () {
        ...
        function (t) {
            ...
            parent.cacheList.purchasesId = $("#grid").jqGrid("getDataIDs")
            parent.tab.addTabItem({
                tabid: "purchases-purchases",
                text: "销售单",
                url: "./scm/invPur.aspx?id=" + e + "&flag=list"
            });
        ...
        function (t) {
            ...
            if (Business.verifyRight("SA_DELETE")) {
                ...
                function () {
                    Public.ajaxGet("../scm/invPurList.aspx?action=delete", {
                        id: e
                    },
                    function (t) {
                        if (200 === t.status) {
        ...
        function (t) {
            ...
            Business.verifyRight("PU_PRINT") && Public.print({
                title: "购货单列表",
                $grid: $("#grid"),
                pdf: "../scm/invPurList.aspx?action=toPdf",
                purchaseType: 10201,
        ...
        if (billRequiredCheck) {
            ...
            function (t) {
                ...
                i = e.join();
                i ? Public.ajaxPost("../scm/invPur.aspx?action=batchCheckInvSa", {
                    id: i
                },
                function (t) {
                    if (200 === t.status) {
            ...
            function (t) {
                ...
                var e = $("#grid").jqGrid("getGridParam", "selarrrow"),
                i = e.join();
                i ? Public.ajaxPost("../scm/invPur.aspx?action=rsBatchCheckInvSa", {
                    id: i
                },
                function (t) {
                    if (200 === t.status) {
        ...
        $("#add").click(function (t) {
            ...
            Business.verifyRight("SA_ADD") && parent.tab.addTabItem({
                tabid: "purchases-purchases",
                text: "销售单",
                url: "./scm/invPur.aspx?action=initSale"
            })
        });
