<%@ Page Language="C#" AutoEventWireup="true" Inherits="invSa,WebApp" %>
...
<div class="wrapper">
  ...
  <div class="bills" id='sale123' style="width:1192px;">
    <div class="con-header">
      <dl class="cf">
        ...
        <dd class="p25 tc">
          <label>单据日期:</label>
          <input type="text" id="saleDate" class="ui-input ui-datepicker-input" value="2014-06-23">
        </dd>
