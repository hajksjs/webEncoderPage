...
THISPAGE = {
    ...
    initDom: function (t) {
        ...
        //this.$_purchaseDate = $("#purchaseDate").val(system.endDate);
        this.$_purchaseDate = $("#purchaseDate");
        this.$_purchaseDate.val(SYSTEM.curDate);
        this.$_number = $("#number");
        ...
        this.supplierArrears = 0;

        if ("add" !== t.status || t.supplierID) var i = t.supplierID; //var i = ["id", t.supplierID];
        else var i = 0;

        this.supplierCombo = Business.supplierCombo($("#supplier"), {
            defaultSelected: i, emptyOptions: !0
        });
/**/
        this.supplierCombo.selectByValue(i, !1);

        hideSupplierCombo && this.supplierCombo.disable();
        ...
        r = '<!--<a id="original" class="ui-btn ui-btn-sc">选择源单</a>--><a id="add" class="ui-btn ui-btn-sp">新增</a><a id="edit" class="ui-btn">保存</a><a href="/scm/invPur.aspx?action=toPdf&id=' + t.id + '" target="_blank" id="print" class="ui-btn">打印</a>',
        n = '<a id="add" class="ui-btn ui-btn-sp">新增</a><a href="/scm/invPur.aspx?action=toPdf&id=' + t.id + '" target="_blank" id="print" class="ui-btn">打印</a>',
        o = "",
        s = "";
        ...
        if (t.id !== '') {
            ...
            this.$_purchaseDate.val(Public.parseDate('Y-m-d', String(t.purchaseDate).replace(/[^0-9]/ig, "") / 1000));
            ...
            this.idList = parent.cacheList.purchasesId || [];
...
reloadData: function (t) {
    function e() {
        i.supplierCombo.selectByValue(t.supplierID, !1);
        //i.supplierCombo.selectByValue(t.supplierID, '');
        //i.$_purchaseDate.val(t.purchaseDate);
        i.$_purchaseDate.val(Public.parseDate('Y-m-d', t.purchaseDate.replace(/[^0-9]/ig, "") / 1000));
...
disableEdit: function () {
    this.supplierCombo.disable();
    this.$_purchaseDate.attr("disabled", "disabled").addClass("ui-input-dis");
...
enableEdit: function () {
    !hideSupplierCombo && this.supplierCombo.enable();
    this.$_purchaseDate.removeAttr("disabled").removeClass("ui-input-dis");
...
addEvent: function () {
    var t = this;
    this.supplierCombo.input.enterKey();
    this.employeeCombo.input.enterKey();
    this.$_purchaseDate.bind("keydown",
        function (t) {
    ...
    Business.billsEvent(t, "purchases");
    ...
    r = Number(a + THISPAGE.supplierArrears);
    ...
    $(".wrapper").on("click", "#save",
        function (e) {
            ...
            if (i) {
                ...
                Public.ajaxPost("../scm/invPur.aspx?action=add", {
    ...
    $(".wrapper").on("click", "#edit",
        function (t) {
            ...
            if (Business.verifyRight("SA_UPDATE")) {
                ...
                e && Public.ajaxPost("../scm/invPur.aspx?action=update", {
    ...
    $(".wrapper").on("click", "#audit",
        function (e) {
            ...
            if (Business.verifyRight("SA_CHECK")) {
                var i = THISPAGE.getPostData();
                i && Public.ajaxPost("../scm/invPur.aspx?action=check", {
                    postData: JSON.stringify(i)
                },
                function (e) {
                    if (200 === e.status) {
    ...
    $(".wrapper").on("click", "#reAudit",
        function (e) {
            ...
            if (Business.verifyRight("SA_UNCHECK")) {
                var i = THISPAGE.getPostData();
                i && Public.ajaxPost("/scm/invPur.aspx?action=revsCheckInvSa", {
                    postData: JSON.stringify(i)
                },
                function (e) {
                    if (200 === e.status) {
    ...
    $(".wrapper").on("click", "#savaAndAdd",
        function (e) {
            e.preventDefault();
            var i = THISPAGE.getPostData();
            i && Public.ajaxPost("../scm/invPur.aspx?action=addNew", {
                postData: JSON.stringify(i)
            },
            function (e) {
                if (200 === e.status) {
    ...
    $(".wrapper").on("click", "#add",
        function (t) {
            ...
            Business.verifyRight("SA_ADD") && parent.tab.overrideSelectedTabItem({
                tabid: "purchases-purchases",
                text: "采购单",
                url: "./scm/invPur.aspx?action=initPur"
            })
        });
    $(".wrapper").on("click", "#print",
        function (t) {
            ...
            Business.verifyRight("SA_PRINT") && Public.print({
                title: "销货单列表",
                $grid: $("#grid"),
                pdf: "/scm/invPur.aspx?action=toPdf",
                purchaseType: 10201,
                filterConditions: {
                    id: originalData.id
                }
    ...
    $(".wrapper").on("click", "#original",
        function (t) {
            ...
            $.dialog({
                ...
                data: {
                    url: "/scm/invPur.aspx?action=findUnhxList&supplierID=" + originalData.supplierID + "&id=" + originalData.id
                },
                lock: !0,
                ok: function () {
    ...
    $("#prev").click(function (e) {
        ...
        Public.ajaxGet("../scm/invPur.aspx?action=get", {
...
getPostData: function () {
    ...
    var e = t.supplierCombo.getValue();
    if ("" === e || 0 === e) {
        parent.Public.tips({
            type: 2,
            content: "销货单位不能为空！"
    ...
    if (i.length > 0) {
        ...
        var a = {
            id: originalData.id,
            //supplierID: e,
            supplierID: t.supplierCombo.getValue(), //t.supplierCombo.getText(),
            purchaseDate: $.trim(t.$_purchaseDate.val()),
