...
function($) {
    ...
    window.liger = $.ligerui = {
        ...
        remove: function(e) {
            ...
            else if ("object" == typeof e) if (e instanceof liger.core.Component) delete liger.managers[e.id];
            else {
        ...
        run: function(e, t, i) {
            if (e) {
                ...
                if (null == this || this == window || i.isStatic) {
                    ...
                    return new $.ligerui[i.controlNamespace][e]($.extend({},
                    $[i.defaultsNamespace][e] || {},
                    $[i.defaultsNamespace][e + "String"] || {},
                    t.length > 0 ? t[0] : {}))
                }
                liger.plugins[e] || (liger.plugins[e] = {
                ...
                this.each(function() {
                    if (this[i.idAttrName] || $(this).attr(i.idAttrName)) {
                        ...
                        s = $.extend({},
                        $[i.defaultsNamespace][e], $[i.defaultsNamespace][e + "String"], a);
    ...
    $.extend(liger.core.Component.prototype, {
        ...
        set: function(e, t) {
            if (e) if ("object" != typeof e) {
                ...
                e);
                if (void 0 == t || 1 == t) for (var s in a) 0 == s.indexOf("on") && this.set(s, a[s]);
                if (void 0 == t || 0 == t) for (var s in a) 0 != s.indexOf("on") && this.set(s, a[s])
            }
        },
        get: function(e) {
        ...
        bind: function(e, t, i) {
            if ("object" != typeof e) {
                ...
                this.events[r] = a
            } else for (var s in e) this.bind(s, e[s])
        },
        unbind: function(e, t) {
            if (e) {
                var i = e.toLowerCase(),
                ...
                if (r && r.length) if (t) {
                    for (var a = 0,
                    s = r.length; s > a; a++) if (r[a].handler == t) {
                        r.splice(a, 1);
                        break
                    }
    ...
    liger.win = {
        ...
        hasTask: function() {
            for (var e in this.tasks) if (this.tasks[e]) return ! 0;
            return ! 1
        },
    ...
    liger.toJSON = "object" == typeof JSON && JSON.stringify ? JSON.stringify: function(e) {
        ...
        if ("object" === a) {
            ...
            if (e.constructor === Array) {
                for (var o = 0,
                n = e.length; n > o; o++) s.push(liger.toJSON(e[o]) || "null");
                return "[" + s.join(",") + "]"
            }
            var l, d;
            for (var c in e) {
...
function(t) {
    ...
    t.ligerui.controls.Tab.ligerExtend(t.ligerui.core.UIComponent, {
        ...
        _render: function() {
            ...
            if (i.height) if ("string" == typeof i.height && i.height.indexOf("%") > 0) {
                e.onResize();
        ...
        setTabManageEven: function() {
            ...
            t("#tabManage").click(function() {
                ...
                if (0 === t(".l-tab-menu").length) {
                    ...
                    t(".l-tab-menu").css({
                        top: i.top + 30 + "px",
                        left: i.left - t(".l-tab-menu").outerWidth() + t("#tabManage").outerWidth() + "px"
                    });
        ...
        moveToPrevTabItem: function() {
            ...
            for (var a = -1 * parseInt(e.tab.links.ul.css("left")), s = 0; s < r.length - 1; s++) if (r[s] < a && r[s + 1] >= a) {
                e.tab.links.ul.animate({
                    left: -1 * parseInt(r[s])
                });
                return
        ...
        moveToNextTabItem: function() {
            ...
            for (var d = -1 * parseInt(e.tab.links.ul.css("left")), c = 1; c < o.length; c++) if (o[c] <= d && o[c - 1] > d) {
                e.tab.links.ul.animate({
        ...
        overrideTabItem: function(e, i) {
            ...
            u = t(".l-tab-content-item[tabid=" + e + "]", r.tab.content),
            p = t("div:first", u).show();
            if (c && u) {
                c.attr("tabid", a);
                u.attr("tabid", a);
                0 == t("iframe", u).length && s ? u.html("<iframe frameborder='0'></iframe>") : o && u.html(o);
                t("iframe", u).attr("name", a);
                void 0 == l && (l = !0);
                0 == l ? t(".l-tab-links-item-close", c).remove() : 0 == t(".l-tab-links-item-close", c).length && c.append("<div class='l-tab-links-item-close'></div>");
                void 0 == n && (n = a);
                d && u.height(d);
                t("a", c).text(n);
                t("iframe", u).attr("src", s).bind("load.tab",
                function() {
                    p.hide();
        ...
        addTabItem: function(e) {
            ...
            if (i.isTabItemExist(a)) {
                ...
                var u = t("<li><a></a><div class='l-tab-links-item-left'></div><div class='l-tab-links-item-right'></div><div class='l-tab-links-item-close'></div></li>"),
                p = t("<div class='l-tab-content-item'><div class='l-tab-loading' style='display:block;'></div><iframe frameborder='0'></iframe></div>"),
                h = t("div:first", p),
                f = t("iframe:first", p);
                if (i.makeFullHeight) {
                ...
                u.attr("tabid", a);
                p.attr("tabid", a);
                if (s) f.attr("name", a).attr("id", a).attr("src", s).bind("load.tab",
                function() {
                    h.hide();
                ...
                o ? p.html(o) : e.target && p.append(e.target);
                void 0 == l && (l = !0);
                0 == l && t(".l-tab-links-item-close", u).remove();
                void 0 == n && (n = a);
                d && p.height(d);
                t("a", u).text(n);
        ...
        reload: function(e) {
            ...
            s = t(a).attr("src");
            r.show();
            a.attr("src", s).unbind("load.tab").bind("load.tab",
            function() {
                r.hide()
            })
        },
