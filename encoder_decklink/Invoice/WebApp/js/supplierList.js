function initGrid() {
    ...
    e = ["操作", "供应商编号", "供应商名称", "联系人", "手机", "座机", "QQ/MSN", "地址", "期初应付款", "期初预付款"],
    ...
    */];
    $("#grid").jqGrid({
        url: "../basedata/contact.aspx?action=list&isDelete=2&type=10",
        datatype: "json",
        autowidth: !0,
        height: t.h,
        altRows: !0,
        ...
        loadComplete: function (t) {
            if (t && 200 == t.status) {
                ...
                var a = 250 === t.status ? searchFlag ? "没有满足条件的结果哦！" : "没有供应商数据哦！" : t.msg;
                parent.Public.tips({
                    type: 2,
                    content: a
                })
...
function initEvent() {
    ...
    function (t) {
        ...
        t.preventDefault();
        var e = "按供应商编号，供应商名称，联系人，电话等查询" === $_matchCon.val() ? "" : $.trim($_matchCon.val());
    ...
    $("#btn-export").on("click",
    function () {
        var t = "按供应商编号，供应商名称，联系人，电话等查询" === $_matchCon.val() ? "" : $.trim($_matchCon.val());
        $(this).attr("href", "/basedata/supplier.aspx?action=exporter&isDelete=2&skey=" + t)
    });
...
filterClassCombo, handle = {
    operate: function (t, e) {
        ...
        $.dialog({
            title: i,
            content: "url:./settings/supplier-manage.aspx",
            data: r,
            width: 640,
            height: 422,
            max: !1,
    ...
    del: function (t) {
        $.dialog.confirm("删除的供应商将不能恢复，请确认是否删除？",
        function () {
