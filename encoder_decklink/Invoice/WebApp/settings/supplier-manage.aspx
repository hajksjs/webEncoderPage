<%@ Page Language="C#" AutoEventWireup="true"  Inherits="suppliermanage,WebApp" %>
    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form" id="base-form">
    			...
    			<li class="row-item">
    				...
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="mobile" id="mobile"></div>
    			</li>
    			<li class="row-item odd ">
    				<div class="label-wrap"><label for="telephone">座机</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="telephone" id="telephone"></div>
    			</li>
    			<li class="row-item">
    				<div class="label-wrap"><label for="linkIm">QQ</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="linkIm" id="linkIm"></div>
    			</li>
    			<li class="row-item odd ">
    			...
    			<li class="row-item">
    				<div class="label-wrap"><label for="supplierLevel">客户等级</label></div>
    				<div class="ctn-wrap"><span id="supplierLevel"></span></div>
    			</li>
    			<li class="row-item odd">
    			...
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="receivable">期初应收款</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="receivable" id="receivable"></div>
    			</li>
    			<li class="row-item">
    				<div class="label-wrap"><label for="preReceived">期初预收款</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="preReceived" id="preReceived"></div>
    			</li>
    		</ul>
...
<script src="../js/suppliermanage.js"></script>
</body>
</html>